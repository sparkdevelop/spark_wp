<div class="footer" style="height:160px;background-color: #fafafa">
    ...
    <div class="col-md-1 col-sm-1 col-xs-1" style="text-align: right">
        ...
        <ul class="list-group">
            <li class="list-group-item" style="background-color: #fafafa"><a href="<?php echo site_url();?>/index.php/wiki" style="margin-bottom: 5px">wiki</a></li>
            <li class="list-group-item" style="background-color: #fafafa"><a href="<?php echo site_url(); ?>/index.php/qa" style="margin-bottom: 5px">问答</a></li>
            <li class="list-group-item" style="background-color: #fafafa"><a href="<?php echo site_url(); ?>/index.php/project" style="margin-bottom: 5px">项目</a></li>
        </ul>
    </div>
    <div class="clearfix visible-xs"></div>
